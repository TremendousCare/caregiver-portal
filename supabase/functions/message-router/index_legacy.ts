// ─── message-router legacy handler (Phase 0.4 rollback sibling) ───
//
// Verbatim pre-0.4 implementation, lifted into `legacyHandler(req)`. The
// dispatcher in `index.ts` calls this when the
// `app_settings.agent_runtime_cutover.message_router` flag is false.
// Removed in the post-bake cleanup PR.
//
// IMPORTANT: do not refactor this file — drift defeats the rollback.
