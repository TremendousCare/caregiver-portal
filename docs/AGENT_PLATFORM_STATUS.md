...
**Pipeline Health UI** *(spec locked 2026-05-15, PR #350 — implementation PR pending)*
**Phase 1.6.1 — call_taxonomy + context_memory.related_entity_id + Settings editor** *(shipped 2026-05-16, PR #354)*
**Phase 1.6.2 — call_analyst agent manifest + post-call-processor extension** *(in progress 2026-05-16 — extractor shape + handler + system prompt + agent seed + 14-day shadow bake gates promotion)*
